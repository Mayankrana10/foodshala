...
<?php
      function aler(){
        echo '<script>alert("You must log in to order")</script>';     
        ...
        <div class="col-lg-4 col-md-4 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="must.php" onclick="aler()" class="btn btn-success">Add to Cart</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="must.php" class="btn btn-success">Add to Cart</a>
                    </div>
                </div>
            </div>
